-- phpMyAdmin SQL Dump
 ...
 CREATE TABLE `trabajadorsanitario` (
   ...
   `DisponibilidadHorasExtras` tinyint(1) DEFAULT 0,
    `InicioSesion` BOOLEAN NOT NULL DEFAULT FALSE
...
INSERT INTO trabajadorSanitario (`Nombre`, `Apellido`, `Email`, `Contrasena`, `Telefono`, `CentroTrabajo`, `Puesto`, `JornadaID`, `Localidad`, `PreferenciasHorarias`, `DisponibilidadHorasExtras`, `InicioSesion`) 
values ('Enrique','Muriel','talegon2000@gmail.com','papanoel123','658695263','Hospital Universitario','TCAE','3','Salamanca','Tardes',NULL,'0');
