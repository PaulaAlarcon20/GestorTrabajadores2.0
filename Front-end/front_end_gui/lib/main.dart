...
import 'package:intl/date_symbol_data_local.dart'; // Importar intl
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/turnDetail': (context) => TurnoDetallesScreen(
              selectedDay: DateTime.now(), // Fecha por defecto para evitar errores
